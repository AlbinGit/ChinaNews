...
typedef NS_ENUM(NSUInteger, CRISegmentStyle) {

    CRISegmentStyleDefault,     /**< 指示杆和按钮的标题齐平*/
    CRISegmentStyleFlush,       /**< 指示杆和按钮宽度齐平*/
};

@interface CRISegmentViewController : UIViewController
...
@property (nonatomic, assign) CRISegmentStyle style;
