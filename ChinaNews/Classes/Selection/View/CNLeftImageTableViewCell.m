...
@implementation CNLeftImageTableViewCell
...
- (void)setSelectionCell{
    ...
    [_smallIamgeV sd_setImageWithURL:[NSURL URLWithString:@"http://res.silver.org.cn/Uploads/Editor/2016-11-16/582c2f255746c.jpg"] placeholderImage:[UIImage imageNamed:@"cri"]];
